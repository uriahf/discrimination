...
# Discrimination 🖖 {background-iframe="emojis/index.html"}
...
![](line%20of%20patients/line%20-%20Copy%20-%20Copy%2001.svg)
...
![](line%20of%20patients/line_ppcr_01_before.svg)
...
![](counterfactual_decision_medical.svg)

The event of disease 🤢 is [negative]{style="background-color: pink;"}
:::

::: {.column width="50%"}
### Telemarketing

![](counterfactual_decision_telemarketing.svg)

The event of purchase 💳 is [positive]{style="background-color: lightgreen;"}
:::
:::
...
![](healthcare_treatment_worked.svg)
...
![](telemarketing_sleeping_dogs.svg)

Best Strategy: Don't Treat!
...
![](healthcare_lost_cause.svg)

Best Strategy: Don't Treat!

Treatment will not prevent the disease 😔
:::

::: {.column width="50%"}
### Telemarketing

![](telemarketing_sure_things.svg)
...
![](healthcare_nonevent_regardless.svg)
...
![](healthcare_treatment_caused_event.svg)
...
![](telemarketing_persuadables.svg)
...
![](line%20of%20patients/line_ppcr_01_after.svg)

## PPCR of 1

![](line%20of%20patients/line_ppcr_1_before.svg)
...
make_gt_auc_table(auc_data[1:4,])
...
make_gt_auc_table(auc_data[1:5,])
...
<!-- $\begin{aligned} \ {\scriptsize \text{C-index} = \frac{\text{#Concordants}}{\text{#Concordants + #Noncorcodants}} = \frac{\text{4 +}}{\text{5 + }}}\end{aligned}$ -->
...
make_gt_auc_table(auc_data[6:10,])
...
$\begin{aligned} \ {\scriptsize \text{C-index} = \frac{\text{#Concordants}}{\text{#Concordants + #Noncorcodants}} = \frac{\text{4 + 5 +}}{\text{5 + 5 +}}}\end{aligned}$

![](cindex_binary_1_a.svg)
...
make_gt_auc_table(auc_data[11:15,])
...
$\begin{aligned} \ {\scriptsize \text{C-index} = \frac{\text{#Concordants}}{\text{#Concordants + #Noncorcodants}} = \frac{\text{4 + 5 + 4 +}}{\text{5 + 5 + 5 +}}}\end{aligned}$
...
make_gt_auc_table(auc_data[16:20,])
...
$\begin{aligned} \ {\scriptsize \text{C-index} = \frac{\text{#Concordants}}{\text{#Concordants + #Noncorcodants}} = \frac{\text{4 + 5 + 4 + 5 +}}{\text{5 + 5 + 5 + 5 +}}}\end{aligned}$
...
make_gt_auc_table(auc_data[21:25,])
...
$\begin{aligned} \ {\scriptsize \text{C-index} = \frac{\text{#Concordants}}{\text{#Concordants + #Noncorcodants}} = \frac{\text{4 + 5 + 4 + 5 + 5 }}{\text{5 + 5 + 5 + 5 + 5}}}\end{aligned}$
...
$\begin{aligned} \ {\scriptsize \text{C-index} = \frac{\text{#Concordants}}{\text{#Concordants + #Noncorcodants}} = \frac{\text{23 }}{\text{25}} = 0.92}\end{aligned}$
